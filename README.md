...
> Documentación completa del trabajo   ➠   [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.17923969.svg)](https://doi.org/10.5281/zenodo.17923969)
...
Este proyecto presenta el **diseño y cálculo** de una máquina de ensayo de tracción para todo tipo de plásticos, pero con mayor foco en materiales utilizados en **Manufactura Aditiva** (FFF/FDM, SLA, SLS, etc.). 
La máquina busca ser:
...
- 💡 Desarrollar el método de ensayo de tracción sin el uso de un extensómetro (ver sección 6.8 del informe  ➠  [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.17923969.svg)](https://doi.org/10.5281/zenodo.17923969)) 
...
│   │   └── electrical/          # Planos eléctricos con esquema de componentes, topográfico y conexionado
